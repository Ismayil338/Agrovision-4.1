                ...
                <div className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-surface-light dark:bg-surface-dark">
                  ...
                  <div className="absolute bottom-6 right-6 w-64 rounded-xl border border-white/20 bg-white/10 p-4 backdrop-blur-xl">
                    <div className="mb-3 flex items-center justify-between">
                      <span className="text-xs font-bold text-white uppercase tracking-wider">{t('home.aiScanStatus')}</span>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-white">
                        <span className="text-sm font-medium">{t('home.healthyCrop')}</span>
        ...
        <section className="bg-slate-50 dark:bg-slate-900/50 py-24">
          <div className="mx-auto max-w-[1280px] px-6">
            <div className="mb-16 text-center">
              <h2 className="mb-4 text-3xl font-bold dark:text-white">{t('home.featuresTitle')}</h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="group flex flex-col gap-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-surface-light dark:bg-surface-dark p-8 hover:border-primary/50 transition-colors">
                ...
                <h3 className="text-xl font-bold dark:text-white">{t('home.aiPrecision')}</h3>
                <p className="text-slate-600 dark:text-slate-400">{t('home.aiPrecisionDesc')}</p>
              </div>
              <div className="group flex flex-col gap-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-surface-light dark:bg-surface-dark p-8 hover:border-primary/50 transition-colors">
                ...
                <h3 className="text-xl font-bold dark:text-white">{t('home.instantDiagnostics')}</h3>
                <p className="text-slate-600 dark:text-slate-400">{t('home.instantDiagnosticsDesc')}</p>
              </div>
              <div className="group flex flex-col gap-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-surface-light dark:bg-surface-dark p-8 hover:border-primary/50 transition-colors">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-background-dark transition-all">
                  <span className="material-symbols-outlined text-3xl">language</span>
                </div>
                <h3 className="text-xl font-bold dark:text-white">{t('home.globalReach')}</h3>
                <p className="text-slate-600 dark:text-slate-400">{t('home.globalReachDesc')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-[1280px] px-6 py-24">
          <div className="relative overflow-hidden rounded-3xl bg-background-dark px-8 py-16 text-center shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
              <h2 className="text-3xl font-black text-white lg:text-5xl">{t('home.ctaTitle')}</h2>
              <p className="max-w-2xl text-lg text-slate-400">{t('home.ctaDesc')}</p>
