          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-primary/10 border border-primary/20 cursor-pointer hover:bg-primary/20 transition-all">
              ...
              <div className="overflow-hidden">
                <p className="text-sm font-bold truncate">{t('analysis.tomatoHealthy')}</p>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer transition-all border border-transparent">
              ...
              ></div>
              <div className="overflow-hidden">
                <p className="text-sm font-bold truncate">{t('analysis.potatoBlight')}</p>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer transition-all border border-transparent">
              ...
              ></div>
              <div className="overflow-hidden">
                <p className="text-sm font-bold truncate">{t('analysis.appleRust')}</p>
        ...
        <div className="p-4 border-t border-[#cee8ce] dark:border-[#2a4d2a]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-[#499c49]">{t('analysis.premiumPlan')}</p>
            </div>
      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        <div className="p-8 max-w-5xl mx-auto w-full flex flex-col gap-8">
          <section className="space-y-2">
            <h1 className="text-4xl font-black tracking-tight">{t('analysis.plantDiseaseAnalysis')}</h1>
            <p className="text-[#499c49] text-lg max-w-2xl">{t('analysis.analysisDesc')}</p>
          </section>
          <div className="relative group">
            <div className="flex flex-col items-center justify-center min-h-[400px] border-4 border-dashed border-[#cee8ce] dark:border-[#2a4d2a] rounded-3xl bg-surface-light dark:bg-surface-dark hover:border-primary transition-all p-12 text-center">
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-bold">{t('analysis.uploadImageTitle')}</h3>
                  <p className="text-[#499c49] max-w-md mx-auto">{t('analysis.uploadImageDesc')}</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="p-6 rounded-2xl bg-surface-light dark:bg-surface-dark border border-[#cee8ce] dark:border-[#2a4d2a] space-y-3">
              ...
              <h4 className="font-bold">{t('analysis.fastDetection')}</h4>
              <p className="text-sm text-[#499c49]">{t('analysis.fastDetectionDesc')}</p>
            </div>
            <div className="p-6 rounded-2xl bg-card-light dark:bg-card-dark border border-[#cee8ce] dark:border-[#2a4d2a] space-y-3">
              ...
              <h4 className="font-bold">{t('analysis.accuracy98')}</h4>
              <p className="text-sm text-[#499c49]">{t('analysis.accuracy98Desc')}</p>
            </div>
            <div className="p-6 rounded-2xl bg-card-light dark:bg-card-dark border border-[#cee8ce] dark:border-[#2a4d2a] space-y-3">
              <span className="material-symbols-outlined text-primary !text-3xl">medical_services</span>
              <h4 className="font-bold">{t('analysis.treatmentGuide')}</h4>
              <p className="text-sm text-[#499c49]">{t('analysis.treatmentGuideDesc')}</p>
            </div>
          </div>
        </div>
      </main>
