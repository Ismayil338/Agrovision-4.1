    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-10 text-center md:text-left">
          <h2 className="text-4xl font-black text-slate-900 dark:text-white mb-2">Plant Disease Gallery</h2>
          <p className="text-slate-500 dark:text-slate-400 max-w-2xl">
            Identify, treat, and prevent common plant ailments with our bilingual agricultural library.
          </p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="w-full lg:w-64 space-y-8 flex-shrink-0">
            ...
            <div>
              ...
              <div className="space-y-3 px-2">
                <label className="flex items-center gap-3 cursor-pointer group">
                  ...
                  <span className="text-sm group-hover:text-primary transition-colors">Fungal (Грибковые)</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input className="rounded border-slate-300 dark:border-slate-700 text-primary focus:ring-primary bg-transparent" type="checkbox" />
                  <span className="text-sm group-hover:text-primary transition-colors">Bacterial (Бактериальные)</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input className="rounded border-slate-300 dark:border-slate-700 text-primary focus:ring-primary bg-transparent" type="checkbox" />
                  <span className="text-sm group-hover:text-primary transition-colors">Viral (Вирусные)</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input className="rounded border-slate-300 dark:border-slate-700 text-primary focus:ring-primary bg-transparent" type="checkbox" />
                  <span className="text-sm group-hover:text-primary transition-colors">Pests (Вредители)</span>
                </label>
              </div>
            </div>
            <div className="p-4 rounded-xl bg-accent-orange/10 border border-accent-orange/20">
              <div className="flex items-center gap-2 text-accent-orange mb-2">
                ...
                <span className="font-bold text-sm uppercase">High Risk Zone</span>
              </div>
              <p className="text-xs text-slate-600 dark:text-slate-400">
                Current season alert for Wheat Rust in your region. Check the latest diagnostic reports.
              </p>
            </div>
          </aside>
          {/* Disease Grid */}
          <div className="flex-1">
            <div className="flex items-center justify-between mb-6">
              <p className="text-sm text-slate-500">Showing 12 of 156 diseases</p>
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-slate-400">SORT BY:</span>
                <select className="bg-transparent border-none text-sm font-medium focus:ring-0 cursor-pointer">
                  <option>Most Common</option>
                  <option>Alphabetical</option>
                  <option>Severity</option>
                </select>
              </div>
            </div>
            {/* Placeholder for disease cards - you can add actual disease cards here */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-surface-light dark:bg-surface-dark rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                <p className="text-sm text-slate-500">Disease cards will be displayed here</p>
              </div>
            </div>
          </div>
        </div>
